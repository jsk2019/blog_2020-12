...
public class CommentPacket {
    ...
    private List<ChildCommentPacket> childComments;
    ...
    public List<ChildCommentPacket> getChildComments() {
        return childComments;
    }

    public void setChildComments(List<ChildCommentPacket> childComments) {
